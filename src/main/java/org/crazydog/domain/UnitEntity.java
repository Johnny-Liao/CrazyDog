...
public class UnitEntity {
    ...
    @Basic
    @Column(name = "unit_code", nullable = false, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "unit_name", nullable = false, insertable = true, updatable = true, length = 255)
